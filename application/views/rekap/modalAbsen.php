...
<div class="box" style='max-width:1200px;margin-left:90px;'>
    <div class="box-header with-border">
        <h3 class="box-title">Data Absensi Karyawan ArbooEvolet</h3>
    ...
    <div class="box-body">
        <div class="modal-content">
            <span id="print-area">
                    ...
                    <table style='margin-left:70px;'>
                        <tr>
                            <td style='padding:50px'>
                                <img src="<?php echo base_url(); ?>assets/dist/img/arboo2.png" width='100px'></img>
                            </td>
                            <td> <br>
                                <p style='font-size:20px;text-align:center;'><b>
                                        <font size='5px'>REKAP ABSENSI Karyawan ArbooEvolet <?php echo $gedung->nama_gedung; ?></font>
                                    </b></p>
                ...
                <b style="padding-left : 30px">L = LUPA ABSEN</b>&nbsp;&nbsp;&nbsp;
